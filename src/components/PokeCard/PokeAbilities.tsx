...
export const PokeAbilities: FC<Props> = ({ type, abilities }) => {
    return (
        <div className="w-full">
            <table className={`border-collapse border border-${type}/80 w-full border-spacing-2 table-auto`}>
                <thead>
                    <tr className="">
                        <th className={`text-xl text-semibold mb-2 text-${type}`}>Abilities</th>
                    </tr>
                </thead>
                <tbody>
